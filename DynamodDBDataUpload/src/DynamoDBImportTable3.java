...
/**
 * This is a class used to import data into the DynamoDB database.
 * 
 * @author fanglinlu
 *
 */
	...
	private static void init() throws Exception {
		...
		try {
			...
			throw new AmazonClientException("Cannot load the credentials from the credential profiles file. "
					...
					+ "location (/Users/fanglinlu/.aws/credentials), and is in valid format.", e);
		}
	...
	public static void getItems(BufferedReader br1) throws Exception {
		...
		while ((line = br1.readLine()) != null) {
			...
			if (prevString != null && prevString.equals(word)) {
				...
				NewTFIDFURLWrapper wrapper = new NewTFIDFURLWrapper(word, Double.parseDouble(df.format(tfIdfValue)),
						url, originUrl);
